...
export declare class Worker<DataType = any, ResultType = any, NameType extends string = string> extends QueueBase {
    ...
    protected nextJobFromJobData(jobData?: JobJsonRaw, jobId?: string, limitUntil?: number, delayUntil?: number, token?: string): Promise<Job<DataType, ResultType, NameType>>;
