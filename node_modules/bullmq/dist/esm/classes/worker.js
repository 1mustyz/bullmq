...
import { delay, DELAY_TIME_1, isNotConnectionError, isRedisInstance, isRedisVersionLowerThan, WORKER_SUFFIX, } from '../utils';
    ...
    async waitForJob() {
        ...
        try {
            ...
            if (!this.closing) {
                ...
                blockTimeout = isRedisVersionLowerThan(this.blockingConnection.redisVersion, '6.0.0')
